...
int main(int argc, char** argv) {
    ...
    nh.setParam("/octomap/max_range", 130); // see the SDF file of the sensor
    nh.setParam("/octomap/min_range", 0.9);
    nh.setParam("/octomap/raycast_range", 130 - 0.9);
